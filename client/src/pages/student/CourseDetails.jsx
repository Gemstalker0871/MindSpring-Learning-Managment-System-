...
const CourseDetails = () => {
  ...
  return courseData ? (
    ...
    <div className='flex md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      <div className='absolute top-0 left-0 w-full h-section-height -z-1 bg-gradient-to-b from-orange-100/70'></div>
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='pt-4 md:text-base text-sm' dangerouslySetInnerHTML={{__html: courseData.courseDescription.slice(0, 200)+ "..."}}></p>
         ...
         <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                ...
                <div className='border border-gray-300 bg-white mb-2 rounded' key={index}>
                  <div className='flex items-center justify-between px-4 py-3 cursor-pointer select-none' onClick={()=> toggleSection(index)}>
                    <div className='flex items-center gap-2'>
                      <img src={assets.down_arrow_icon} alt="arrow" className={`transform transition-transform ${openSection[index] ? 'rotate-180' : ''}`} />
                    ...
                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300'>
                      {chapter.chapterContent.map((lecture, i) => (
                        <li className='flex items-start gap-2 py-1' key={i}>
                          <img src={assets.play_icon} alt="paly" className='w-4 h-4 mt-1' />
          ...
          <div className='py-20 text-s md:text-default'>
      ...
      {/* right Column */}
      <div className='max-w-course-card xl:max-w-[700px]  z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
        {
        ...
        <div className='p-5'>
          ...
          <div className='flex item-center text-sm md:text-default gap-4 pt-2 md:pt-4 text-gray-500'>
              ...
              <div className='flex items-center gap-1'>
                <img src={assets.time_clock_icon} alt="click" />
              ...
              <div className='flex items-center gap-1'>
                <img src={assets.lesson_icon} alt="click" />
          ...
          <div className='pt-6'>
            ...
            <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
              ...
              <li>Downlaod resources and source code.</li>
